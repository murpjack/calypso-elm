...
var $author$project$Main$CoinLoading = {$: 'CoinLoading'};
var $author$project$Main$GotCoinData = function (a) {
	return {$: 'GotCoinData', a: a};
};
var $author$project$Main$GotTextData = function (a) {
	return {$: 'GotTextData', a: a};
};
		...
		$elm$core$Platform$Cmd$batch(
			_List_fromArray(
				[
					$elm$http$Http$get(
					{
						expect: $elm$http$Http$expectString($author$project$Main$GotTextData),
						url: 'https://elm-lang.org/assets/public-opinion.txt'
					}),
					$elm$http$Http$get(
					{
						expect: $elm$http$Http$expectString($author$project$Main$GotCoinData),
						url: 'https://elm-lang.org/assets/public-opinion.txt'
					})
				])));
};
...
var $author$project$Main$showCBData = function (status) {
	switch (status.$) {
		...
		case 'CoinFailure':
			return 'Failure.';
		default:
			var fullText = status.a;
			return fullText;
	}
};
var $author$project$Main$showData = function (status) {
	switch (status.$) {
		case 'Loading':
			return 'Loading...';
		case 'Failure':
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Main$showCBData(model.coinData))
					])),
				A2(
				$elm$html$Html$p,
				_List_Nil,
				_List_fromArray(
					[
						$elm$html$Html$text(
						$author$project$Main$showData(model.textData))
					]))
			]));
};
